...
class SubscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'subscribe offers with non user' do
    ...
    assert_equal '[Fahrsammlung] ' + I18n.t('subscriptions.confirmation_request.subject'), confirm_email.subject
  ...
  test 'subscribe requests when offers already subscribed and confirmed' do
    ...
    assert_equal '[Fahrsammlung] ' + I18n.t('subscriptions.subscribe_notification.subject'), subscribe_email.subject
  ...
  test 'subscribe requests when offers already subscribed but not confirmed' do
    ...
    subscribe_email = ActionMailer::Base.deliveries.last
    assert_equal '[Fahrsammlung] ' + I18n.t('subscriptions.confirmation_request.subject'), subscribe_email.subject
    assert_equal subscriber.email, subscribe_email.to[0]
  ...
  test 'unsubscribe everything user from offers when not signed in' do
    ...
    assert_equal '[Fahrsammlung] ' + I18n.t('subscriptions.unsubscribe_notification.subject'), unsubscribe_email.subject
